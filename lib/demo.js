...
export function demoPayload() {
  ...
  return {
    ...
    filings: [
      ...
      { form: "8-K", label: "Material event report", filed: "2026-07-28", url: "" },
      { form: "4", label: "Insider trade disclosure", filed: "2026-07-15", url: "" },
      { form: "DEF 14A", label: "Proxy statement (pay, board, votes)", filed: "2026-05-02", url: "" },
