...
What you get:
- The warm feeling of funding software that refuses to lie to you
- Your name in SUPPORTERS.md (optional — tell me the name to list)
- Priority on feature requests

What you don't get: stock predictions. Nobody sells real ones; we're just
the only analyzer that says so on the box.
